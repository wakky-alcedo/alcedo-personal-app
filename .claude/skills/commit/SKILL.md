...
2. **仕様書の差分確認・同期**
   ...
   以下の2ファイルを確認し、今回の変更内容が未反映の箇所があれば先に更新する（メインのコミットに含める）。

   ### `docs/REQUIREMENTS.md`
   ユーザー視点の機能要件を記載。以下に該当する変更は更新する：
   - 新しいユーザー向け機能・振る舞いの追加
   - 既存機能の仕様変更（フィルタ条件、表示ルール、通知挙動など）
...
git add docs/REQUIREMENTS.md docs/TECH_SPEC.md
```
